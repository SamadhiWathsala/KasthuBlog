			...
			<div class="col-sm-10">
                ...
                ?>
                    ...
                    <div>
                        ...
                        <form action="EditPost.php ?Edit=<?php echo $_GET['Edit'];?>" method="post" enctype="multipart/from-data">
                            <fieldset>
                                <div class="form-grop">
                                    <label for="title"> <span class="FieldInfo">Title:</span> </label>
                                    <input value="<?php echo $TitletoBeUpdate; ?>" class="form-control" type="text" name="Title" id="title" placeholder="Title">
                                </div>
                                <br>
                                <div class="form-grop">
