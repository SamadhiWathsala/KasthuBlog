...
if(isset($_POST["Submit"])){
 ...
 elseif(strlen($Comment)>500){
    ...
    global $Connections;
    $Query = "INSERT INTO comments(datetime,name,email,comment,status)VALUES
    ('$DateTime',' $Name','$Email','$Comment','OFF')";
...
<html>
        ...
        <head>
                ...
                <br><br>
                                    ...
                                    <form action="FullPost.php?id='$_GET['id']'" method="post" enctype="multipart/from-data">
